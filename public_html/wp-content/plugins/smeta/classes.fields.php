...
class SM_Datetime_Timestamp_Field extends SM_Field {
	...
	public function html() { ?>		
		<input <?php $this->id_attr('date'); ?> <?php $this->boolean_attr(); ?> <?php $this->class_attr( 'sm_text_small sm_datepicker' ); ?> type="text" <?php $this->name_attr( '[date]' ); ?>  value="<?php echo !empty( $this->value ) && $this->value !== '-1' ? esc_attr( date( 'm\/d\/Y', $this->value ) ) : '' ?>" />
		<input <?php $this->id_attr('time'); ?> <?php $this->boolean_attr(); ?> <?php $this->class_attr( 'sm_text_small sm_timepicker' ); ?> type="text" <?php $this->name_attr( '[time]' ); ?> value="<?php echo !empty( $this->value ) && $this->value !== '-1' ? esc_attr( date( 'H:i', $this->value ) ) : '' ?>" />
	<?php }
	public function parse_save_values() {
